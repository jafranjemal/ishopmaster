...
const warrantyPolicyRoutes = require("./routes/warrantyPolicyRoutes");
const warrantyAuditRoutes = require("./routes/warrantyAuditRoutes");
...
app.use("/api/warranty-policies", warrantyPolicyRoutes);
app.use("/api/warranty-audit", warrantyAuditRoutes);
