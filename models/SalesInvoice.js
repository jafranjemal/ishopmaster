...
const salesInvoiceSchema = new mongoose.Schema({
  ...
  global_discount_type: { type: String, enum: ["Fixed", "Percentage"], default: "Fixed" },
  global_discount_value: { type: Number, default: 0 },
  ...
  invoice_type: {
    type: String,
    enum: ['Sale', 'Service', 'mixed'], // Added mixed
    default: 'Sale'
  },
  serviceItems: [],
  ticketId: {
  ...
  // TOON ENHANCEMENTS
  partsUsed: [{ type: mongoose.Schema.Types.ObjectId, ref: "Item" }],
  warrantyIssued: { type: Boolean, default: false },
  warrantyId: { type: String } // Reference to Warranty Token ID
